  ...
  return (
    <div className="min-h-dvh bg-stone-50 dark:bg-stone-900 flex flex-col justify-center pt-8 pb-32 sm:px-6 lg:px-8 relative">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-stone-800 py-8 px-4 shadow-sm border border-stone-200 dark:border-stone-700 sm:rounded-2xl sm:px-10">
          {sucesso ? (
            ...
            <>
              ...
              {erro && (
                <div className="text-red-600 dark:text-red-400 text-sm bg-red-50 dark:bg-red-900/30 p-3 rounded-lg border border-red-100 dark:border-red-900/50">
                  {erro}
                </div>
              )}
