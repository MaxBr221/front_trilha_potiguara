...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      {/* Developer Links */}
      <div className="mt-8 sm:mx-auto w-full sm:max-w-md flex flex-col items-center justify-center px-4 pb-8">
        <p className="text-sm font-medium text-stone-400 mb-3 text-center">Desenvolvido por</p>
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 w-full">
          <a 
            ...
            className="flex items-center gap-2 text-stone-500 hover:text-[#E1306C] transition-colors bg-white border border-stone-200 px-4 py-2 rounded-full font-medium text-sm shadow-sm"
          >
