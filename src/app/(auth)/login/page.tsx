        ...
        <div className="bg-white py-8 px-4 shadow-sm border border-stone-200 sm:rounded-3xl sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              ...
              <div className="mt-8 pt-6 border-t border-stone-100 flex flex-col items-center justify-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 w-full">
                  <a 
                    ...
                    className="flex items-center gap-2 text-stone-500 hover:text-[#E1306C] transition-colors bg-stone-50 border border-stone-100 px-3 py-1.5 rounded-full font-medium text-xs shadow-sm"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-stone-500 hover:text-[#0a66c2] transition-colors bg-stone-50 border border-stone-100 px-3 py-1.5 rounded-full font-medium text-xs shadow-sm"
                  >
