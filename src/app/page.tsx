        ...
        <section className="py-24 bg-stone-50 dark:bg-stone-900/50 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-stone-600 dark:text-stone-300 text-lg max-w-2xl mx-auto">Muito mais que um sistema de idiomas, uma jornada de imersão e aprendizado progressivo.</p>
            </div>
