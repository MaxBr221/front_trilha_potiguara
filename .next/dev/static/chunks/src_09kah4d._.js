...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login(email, senha);
            if (response.user) {
...
_s(LoginPage, "eFykrLl7V0iZqDtwZEy6Fak536c=", false, function() {
    return [
...
//# sourceMappingURL=src_09kah4d._.js.map