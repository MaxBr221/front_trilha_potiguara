...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].register(nome, email, senha);
            setSuccess(true);
            setTimeout(()=>{
                router.push('/login');
            }, 2000);
...
//# sourceMappingURL=src_00bwku_._.js.map